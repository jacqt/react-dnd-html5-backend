	...
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			...
			: 'object' == typeof exports
				? (exports.ReactDnDHTML5Backend = t())
				: (e.ReactDnDHTML5Backend = t())
})(this, function() {
	return (function(e) {
		function t(n) {
				...
				y = (function() {
					function e(t) {
						o(this, e),
							...
							(this.handleTopDragStartCapture = this.handleTopDragStartCapture.bind(
								this,
							)),
							(this.handleTopDragEndCapture = this.handleTopDragEndCapture.bind(
								this,
							)),
							(this.handleTopDragEnter = this.handleTopDragEnter.bind(this)),
							(this.handleTopDragEnterCapture = this.handleTopDragEnterCapture.bind(
								this,
							)),
							(this.handleTopDragLeaveCapture = this.handleTopDragLeaveCapture.bind(
								this,
							)),
							(this.handleTopDragOver = this.handleTopDragOver.bind(this)),
							(this.handleTopDragOverCapture = this.handleTopDragOverCapture.bind(
								this,
							)),
							(this.handleTopDrop = this.handleTopDrop.bind(this)),
							(this.handleTopDropCapture = this.handleTopDropCapture.bind(
								this,
							)),
							...
							(this.asyncEndDragNativeItem = this.asyncEndDragNativeItem.bind(
								this,
							)),
						...
						i(e, [
							...
							},
							{
								...
								value: function(e, t, r) {
									var n = this
									return (
										(this.sourcePreviewNodeOptions[e] = r),
										(this.sourcePreviewNodes[e] = t),
										function() {
											delete n.sourcePreviewNodes[e],
												delete n.sourcePreviewNodeOptions[e]
										}
									)
								},
							},
							{
								...
								value: function(e, t, r) {
									var n = this
									;(this.sourceNodes[e] = t), (this.sourceNodeOptions[e] = r)
									var o = function(t) {
							...
							},
							{
								...
								value: function(e) {
									this.clearCurrentDragSourceNode()
									var t = (0, p.createNativeDragSource)(e)
							...
							},
							{
								...
								value: function(e) {
									...
									var n = (0, h.getEventClientOffset)(e)
									...
									if (this.monitor.isDragging()) {
										if ('function' == typeof o.setDragImage) {
											var a = this.monitor.getSourceId(),
												...
												l = c.offsetX,
												v = c.offsetY,
												g = { anchorX: f, anchorY: d },
												y = { offsetX: l, offsetY: v },
												D = (0, h.getDragPreviewOffset)(u, s, n, g, y)
											o.setDragImage(s, D.x, D.y)
										}
										try {
							...
							},
							{
								...
								value: function(e) {
									...
									if (
										(e.preventDefault(),
										(this.latestEvent = e),
										!this.isHandlingDragOver)
									) {
										this.isHandlingDragOver = !0
										var r = this.dragOverTargetIds
										;(this.dragOverTargetIds = []),
											requestAnimationFrame(function() {
												var e = t.latestEvent
												if (!t.monitor.isDragging() || t.monitor.didDrop())
													return (
														(e.dataTransfer.dropEffect = 'none'),
														void (t.isHandlingDragOver = !1)
													)
												;(t.altKeyPressed = e.altKey),
													...
													r.some(function(e) {
														...
														: t.isDraggingNativeItem()
															? (e.dataTransfer.dropEffect = 'none')
															: t.checkIfCurrentDragSourceRectChanged() &&
																(e.dataTransfer.dropEffect = 'move'),
													(t.isHandlingDragOver = !1)
											})
									}
								},
							},
		...
		function(e, t, r) {
			var n = r(13),
				...
				a = r(66),
				u = i(function(e) {
					return e.push(void 0, a), n(o, void 0, e)
				})
			e.exports = u
		},
		function(e, t, r) {
		...
		function(e, t, r) {
			function n(e, t, r, n) {
				...
				for (var u = -1, s = t.length; ++u < s; ) {
					...
					void 0 === f && (f = e[c]), a ? i(r, c, f) : o(r, c, f)
				}
				return r
			}
			var o = r(38),
		...
		function(e, t, r) {
			function n(e, t, r) {
				var n = e[t]
				;(u.call(e, t) && i(n, r) && (void 0 !== r || t in e)) || o(e, t, r)
			}
			var o = r(14),
				i = r(3),
				a = Object.prototype,
		...
		function(e, t, r) {
			function n(e) {
				return !(!a(e) || i(e)) && (o(e) ? p : c).test(u(e))
			}
			var o = r(16),
				i = r(43),
				a = r(2),
				...
				return o(function(t, r) {
					...
					for (
						a = e.length > 3 && 'function' == typeof a ? (o--, a) : void 0,
							u && i(r[0], r[1], u) && ((a = o < 3 ? void 0 : a), (o = 1)),
							t = Object(t);
						++n < o;
		...
		function(e, t, r) {
			function n(e, t, r) {
				return (
					...
					function() {
						for (
							var n = arguments, a = -1, u = i(n.length - t, 0), s = Array(u);
							++a < u;
		...
		function(e, t, r) {
			...
			function n(e, t) {
				...
				for (
					...
					if (!o.call(t, r[i]) || e[r[i]] !== t[r[i]]) return !1
					if (e[r[i]] !== t[r[i]]) return !1
				}
				return !0
			}
						...
						i(e, [
							{
								...
								value: function(e) {
									...
									return (
										(this.entered = (0, u.default)(this.entered.filter(r), [
											e,
										])),
		...
		function(e, t, r) {
			function n(e, t, r, a, u) {
				var s = -1,
					c = e.length
				for (r || (r = i), u || (u = []); ++s < c; ) {
					var f = e[s]
					t > 0 && r(f)
						? t > 1 ? n(f, t - 1, r, a, u) : o(u, f)
						: a || (u[u.length] = f)
				}
				return u
			}
		...
		function(e, t, r) {
			function n(e, t, r) {
				...
				e: for (; ++n < l; ) {
					var y = e[n],
						D = t ? t(y) : y
					if (((y = r || 0 !== y ? y : 0), h && D === D)) {
						for (var b = v.length; b--; ) if (v[b] === D) continue e
						t && v.push(D), p.push(y)
					} else d(v, D, r) || (v !== p && v.push(D), p.push(y))
				}
				return p
			}
			var o = r(25),
		...
		function(e, t, r) {
			function n(e, t, r, n) {
				...
				r && (t = u(t, s(r))),
					n
						? ((l = a), (h = !1))
						: t.length >= f && ((l = c), (h = !1), (t = new o(t)))
				e: for (; ++d < p; ) {
					var y = e[d],
						D = null == r ? y : r(y)
					if (((y = n || 0 !== y ? y : 0), h && D === D)) {
						for (var b = g; b--; ) if (t[b] === D) continue e
						v.push(y)
					} else l(t, D, n) || v.push(y)
				}
				return v
			}
			var o = r(25),
		...
		function(e, t, r) {
			...
			function i(e) {
				return (
					'IMG' === e.nodeName &&
					((0, s.isFirefox)() || !document.documentElement.contains(e))
				)
			}
			function a(e, t, r, n) {
				var o = e ? t.width : r,
			...
			function u(e, t, r, o, u) {
				var c = i(t),
					d = c ? e : t,
					l = n(d),
					h = { x: r.x - l.x, y: r.y - l.y },
					p = e.offsetWidth,
					v = e.offsetHeight,
					g = o.anchorX,
					y = o.anchorY,
					D = a(c, t, p, v),
					b = D.dragPreviewWidth,
					m = D.dragPreviewHeight,
					x = u.offsetX,
					_ = u.offsetY,
					O = 0 === x || x,
					w = 0 === _ || _
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.getNodeClientOffset = n),
				(t.getEventClientOffset = o),
				(t.getDragPreviewOffset = u)
			var s = r(32),
				c = r(107),
				f = (function(e) {
					return e && e.__esModule ? e : { default: e }
			...
			var o = (function() {
				...
				i = (function() {
					function e(t, r) {
						...
						for (
							var u = [], s = [], c = [], f = void 0, d = void 0, l = 0;
							l < o - 1;
							l++
						)
							(f = t[l + 1] - t[l]),
								...
								u.push(d),
								c.push(d / f)
						for (var h = [c[0]], p = 0; p < s.length - 1; p++) {
							var v = c[p],
								g = c[p + 1]
							if (v * g <= 0) h.push(0)
							else {
								...
								var y = s[p + 1],
									D = f + y
								h.push(3 * D / ((D + y) / v + (D + f) / g))
							}
						}
						h.push(c[c.length - 1])
						for (var b = [], m = [], x = void 0, _ = 0; _ < h.length - 1; _++) {
							x = c[_]
							var O = h[_],
								w = 1 / s[_],
								E = O + h[_ + 1] - x - x
							b.push((x - O - E) * w), m.push(E * w * w)
						}
						;(this.xs = t),
							(this.ys = r),
							(this.c1s = h),
						...
						o(e, [
							{
								...
								value: function(e) {
									...
									var d = e - t[a],
										l = d * d
									return r[a] + n[a] * d + o[a] * l + i[a] * d * l
								},
							},
						]),
						e
						...
						f(e, [
							{
								...
								value: function(e) {
									delete this.item[r], (this.item[r] = a(e, i))
								},
							},
							{
								key: 'canDrag',
			...
			function s(e) {
				...
				return (
					Object.keys(h).filter(function(e) {
						return h[e].matchesTypes.some(function(e) {
