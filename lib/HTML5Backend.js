	...
	_createClass(HTML5Backend, [
		...
		},
		{
			...
			value: function checkIfCurrentDragSourceRectChanged() {
				...
				this.currentDragSourceNodeOffsetChanged = !(0, _shallowEqual2.default)(
			...
			value: function handleTopDragStart(e) {
				...
				if (this.monitor.isDragging()) {
					if (typeof dataTransfer.setDragImage === 'function') {
						...
						var dragPreviewOffset = (0, _OffsetUtils.getDragPreviewOffset)(
							sourceNode,
							dragPreview,
							clientOffset,
							anchorPoint,
		...
		},
		{
			...
			value: function handleTopDragOver(ev) {
				...
				requestAnimationFrame(function() {
					...
					if (!_this6.monitor.isDragging() || _this6.monitor.didDrop()) {
						// This is probably a native item type we don't understand.
					...
					_this6.altKeyPressed = e.altKey

					_this6.actions.hover(dragOverTargetIds, {
						clientOffset: (0, _OffsetUtils.getEventClientOffset)(e),
					})
					...
					if (canDrop) {
						...
						e.dataTransfer.dropEffect = _this6.getCurrentDropEffect()
					} else if (_this6.isDraggingNativeItem()) {
						// Don't show a nice cursor but still prevent default
						// "drop and blow away the whole document" action.
						e.dataTransfer.dropEffect = 'none'
					} else if (_this6.checkIfCurrentDragSourceRectChanged()) {
